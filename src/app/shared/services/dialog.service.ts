...
export class DialogService {
  ...
  public uploadResponsiveImage(
    ...
    dialogReference.componentInstance.setResponsiveImageData(
      responsiveImageData
    );
  ...
  public writeMail(data: any) {
    const dialogRef: MatDialogRef<WriteMailDialog> = this.dialog.open(
      WriteMailDialog
    );
  ...
  public changePassword(user: IUser) {
    const dialogRef: MatDialogRef<ChangePasswordDialogComponent> = this.dialog.open(
